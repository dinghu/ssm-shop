...
public class ApiUserController extends ApiBaseAction {
     ...
     * 保存用户头像
     */
     @ApiOperation(value = "保存用户头像接口",response=Map.class, notes ="保存用户头像接口")
     ...
     * 发送短信
     */
    @ApiOperation(value = "发送短信接口",response=Map.class, notes ="发送短信接口")
...
//        String rpt = "0";
     ...
     * @return
     */
     @ApiOperation(value = "获取当前会员等级接口",response=Map.class, notes ="获取当前会员等级接口")

...
public class PageQuery {
	...
	// 默认10
	private int pageSize = DEFAULTPAGE_SIZE;
	...
	public PageQuery(String orderBy, String orderType, int start) {
		this.pageSize = DEFAULTPAGE_SIZE;
		this.orderBy = orderBy;
		this.maxPageNo = MAX_PAGE_NO;
		this.setOrderType(orderType);
		if (start < 0) {
	...
	public String toString() {
		return "PageQuery [pageNo=" + pageNo + ", pageSize=" + pageSize + ", start=" + start + ", end=" + end
				+ ", totalCount=" + totalCount + ", orderBy=" + orderBy + ", orderType=" + orderType + ", maxPageNo="
				+ maxPageNo + "]";
	}
